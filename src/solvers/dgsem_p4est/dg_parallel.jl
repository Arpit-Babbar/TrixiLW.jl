using Trixi: balance!, partition!, update_ghost_layer!, init_elements,
             ...
             init_interfaces, init_boundaries
...
function create_cache(mesh::ParallelP4estMesh, equations,
                      ...
                      ::Any, ::Type{uEltype}, cache) where {uEltype <: Real}
    ...
    interfaces = init_interfaces(mesh, equations, dg.basis, time_discretization, elements)
