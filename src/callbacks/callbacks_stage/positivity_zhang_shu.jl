...
@muladd begin
    function (limiter!::PositivityPreservingLimiterZhangShu)(u_ode,
                                                             integrator::LWIntegrator,
                                                             semi::AbstractSemidiscretization,
                                                             t)
        u = wrap_array(u_ode, semi)
        @trixi_timeit timer() "positivity-preserving limiter" my_limiter_zhang_shu!(u,
                                                                                    limiter!.thresholds,
                                                                                    limiter!.variables,
    ...
    # is definitely fine.
    function my_limiter_zhang_shu!(u, thresholds::NTuple{N, <:Real},
        ...
        my_limiter_zhang_shu!(u, remaining_thresholds, remaining_variables, mesh, equations,
                              solver, cache)
        return nothing
    end
