...
function rhs!(du_ode, u_ode,
    ...
    time_start = time_ns()
    @trixi_timeit timer() "rhs!" rhs!(du, u, t, cache.dt[1], mesh, equations,
                                      equations_parabolic,
...
function SemidiscretizationHyperbolicParabolic(mesh,
    ...
    return SemidiscretizationHyperbolicParabolic(mesh, time_discretization,
...
function SemidiscretizationHyperbolicParabolic(mesh,
    ...
    cache = (;
             create_cache(mesh, equations, time_discretization, solver, RealT, uEltype,
                          cache)...,
             cache...) # LW additions
    ...
    cache_parabolic = (;
                       create_cache(mesh, equations_parabolic, time_discretization, solver,
