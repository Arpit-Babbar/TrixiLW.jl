...
function limit_slope(eq::CompressibleEulerEquations2D, slope, ufl, u_star_ll,
    ...
    slope, u_star_ll, u_star_rr = limit_variable_slope(eq, Trixi.density, slope, u_star_ll,
                                                       u_star_rr, ue, xl, xr)

    slope, u_star_ll, u_star_rr = limit_variable_slope(eq, Trixi.pressure, slope, u_star_ll,
                                                       u_star_rr, ue, xl, xr)
