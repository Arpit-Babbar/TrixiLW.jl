...
@inline function boundary_condition_slip_wall_vertical(U_inner, F_inner, u_inner,
                                                       outer_cache,
...
@inline function boundary_condition_slip_wall_horizontal(U_inner, F_inner, u_inner,
                                                         outer_cache,
                                                         orientation_or_normal, direction,
                                                         x, t, dt,
                                                         surface_flux_function,
...
function is_admissible(u, equations::AbstractEquations)
    @assert false "Please define specialized method to avoid bugs!"
end
