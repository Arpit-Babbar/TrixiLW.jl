...
@inline function boundary_condition_inflow_dmr(U_inner, F_inner, u_inner,
    ...
    flux = TrixiLW.time_averaged_bc_dirichlet(U_inner, F_inner, u_inner, outer_cache,
                                              normal_direction,
                                              x, t, dt, surface_flux_function, equations,
                                              dg,
...
@inline function boundary_condition_mixed_dirichlet_wall(U_inner, F_inner, u_inner,
    ...
    if x[1] < 1 / 6
        ...
        flux = TrixiLW.boundary_condition_slip_wall_horizontal(U_inner, F_inner, u_inner,
                                                               outer_cache,
                                                               normal_direction,
                                                               x, t, dt,
                                                               surface_flux_function,
...
# Original trixi controller
amr_controller_ = ControllerThreeLevel(semi, amr_indicator,
                                       base_level = 0,
