...
@assert 0.5≈vk_uinf(equations) / vk_a(equations) abs(0.5 -
                                                     vk_uinf(equations) / vk_a(equations))
...
velocity_bc_square = NoSlip((x, t, equations) -> initial_condition_mach3_flow(x, t,
                                                                              equations)[2:3])
...
isfile(default_mesh_file) ||
    download("https://gist.githubusercontent.com/Arpit-Babbar/8e44898b95ea7edad054044aa63671e6/raw/ea3d59e435132f7fcca74d42aa1a77303452d0e6/NACA0012.inp",
             default_mesh_file)
...
drag_force = AnalysisSurfaceIntegral(indices,
                                     TrixiLW.DragForcePressure(vk_aoa(), vk_rho_inf(),
                                                               vk_uinf(equations),
                                                               vk_linf()))
lift_force = AnalysisSurfaceIntegral(indices,
                                     TrixiLW.LiftForcePressure(vk_aoa(), vk_rho_inf(),
                                                               vk_uinf(equations),
                                                               vk_linf()))
drag_force_viscous = AnalysisSurfaceIntegralViscous(indices,
                                                    TrixiLW.DragForceViscous(vk_aoa(),
                                                                             vk_rho_inf(),
                                                                             vk_uinf(equations),
                                                                             vk_linf()))
lift_force_viscous = AnalysisSurfaceIntegralViscous(indices,
                                                    TrixiLW.LiftForceViscous(vk_aoa(),
                                                                             vk_rho_inf(),
                                                                             vk_uinf(equations),
                                                                             vk_linf()))
