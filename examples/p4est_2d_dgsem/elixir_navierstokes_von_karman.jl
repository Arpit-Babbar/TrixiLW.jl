...
@inline function boundary_condition_subsonic(U_inner, f_inner, u_inner,
                                             outer_cache, normal_direction::AbstractVector,
                                             x, t, dt,
...
boundary_conditions = Dict(:Left => boundary_condition_subsonic, # TODO - Put HLL here?
...
boundary_conditions_parabolic = Dict(:Left => boundary_condition_ns_inflow,
...
drag_force = AnalysisSurfaceIntegral(indices,
                                     TrixiLW.DragForcePressure(aoa, rho_inf(), u(centre()),
                                                               linf()))
lift_force = AnalysisSurfaceIntegral(indices,
                                     TrixiLW.LiftForcePressure(aoa, rho_inf(), u(centre()),
                                                               linf()))
drag_force_viscous = AnalysisSurfaceIntegralViscous(indices,
                                                    TrixiLW.DragForceViscous(aoa, rho_inf(),
                                                                             u(centre()),
                                                                             linf()))
lift_force_viscous = AnalysisSurfaceIntegralViscous(indices,
                                                    TrixiLW.LiftForceViscous(aoa, rho_inf(),
                                                                             u(centre()),
                                                                             linf()))
