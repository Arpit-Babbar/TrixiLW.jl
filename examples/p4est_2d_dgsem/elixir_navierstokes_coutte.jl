...
equations_parabolic = TrixiLW.CompressibleNavierStokesDiffusion2D(equations,
                                                                  mu = mu(equations),
...
boundary_condition_ns_bottom = BoundaryConditionNavierStokesWall(velocity_bottom,
                                                                 heat_bottom)
