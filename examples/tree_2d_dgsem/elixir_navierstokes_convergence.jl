...
equations_parabolic = TrixiLW.CompressibleNavierStokesDiffusion2D(equations, mu = mu(),
...
boundary_condition_top_bottom = TrixiLW.BoundaryConditionNavierStokesWall(velocity_bc_top_bottom,
                                                                          heat_bc_top_bottom)
